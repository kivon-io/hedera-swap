...
export default function LiquidityDashboard() {
  ...
  return (
    <>
      <main className='max-w-4xl mx-auto bg-gray-50 p-8'>
        <h1 className='text-2xl font-bold mb-6 text-center text-purple-700'>Liquidity Dashboard</h1>

        <div className='max-w-3xl mx-auto grid gap-6'>
          {/* Add Liquidity Section */}
          <Card className='p-6 shadow-md rounded-2xl bg-white'>
            <h2 className='text-lg font-semibold mb-4 text-purple-700'>Add Liquidity</h2>
          ...
          <Card className='p-6 shadow-md rounded-2xl bg-white'>
            <h2 className='text-lg font-semibold mb-4 text-purple-700'>Your Summary</h2>
        ...
        {txStatus && (
          <p
            className={`fixed bottom-5 left-1/2 transform -translate-x-1/2 px-4 py-2 rounded text-sm ${
              txStatus.startsWith("✅") ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"
            }`}
          >
            {txStatus}
          </p>
